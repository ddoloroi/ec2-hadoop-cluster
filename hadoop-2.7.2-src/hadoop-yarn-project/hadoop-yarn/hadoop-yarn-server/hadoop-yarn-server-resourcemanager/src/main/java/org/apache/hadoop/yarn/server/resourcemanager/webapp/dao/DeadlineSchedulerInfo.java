...
@XmlRootElement(name = "deadlineScheduler")
@XmlType(name = "deadlineScheduler")
...
public class DeadlineSchedulerInfo extends SchedulerInfo {
  ...
  public DeadlineSchedulerInfo(final ResourceManager rm) {

    RMContext rmContext = rm.getRMContext();

    DeadlineScheduler fs = (DeadlineScheduler) rm.getResourceScheduler();
